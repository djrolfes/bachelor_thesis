...
getOptions()
{
  ...
  options.add_options()("h,help", "Show Help")(
    "b,beta",
    "Value of Beta for Simulation",
    cxxopts::value<double>()->default_value("2.0"))(
    "d,delta",
    "Search Radius for Simulation",
    cxxopts::value<double>()->default_value("0.2"))(
    "l,lattice-size",
    "Size of the lattice (l^4)",
    cxxopts::value<int>()->default_value("8"))(
    "hits",
    "Hits per site per Measurement",
    ...
    "partition-tet", "Use the tetrahedral subgroup of SU(2) as a gauge group")(
    "partition-oct", "Use the Octahedral subgroup of SU(2) as a gauge group")(
    "partition-ico", "Use the icosahedral subgroup of SU(2) as a gauge group")(
    ...
    "partition-c24",
    "Use the 24 vertices of the 24-cell as a gauge set "
    "(Same as --partition-tet)")(
    "partition-c120", "Use the 600 vertices of the 120-cell as a gauge set")(
    "partition-c600",
    "Use the 120 vertices of the 600-cell as a gauge set "
    ...
    cxxopts::value<int>())(
    "partition-linear", "Use linear mesh on SU(2)", cxxopts::value<int>())(
    "partition-linear-weighted",
    "Use linear mesh on SU(2) with adjusted probabilities",
    cxxopts::value<int>())("partition-z2", "Use the gauge group z2")(
    "c,cold", "Cold Start")("v,verbose",
                            "Verbose output",
...
main(int argc, char** argv)
{
  ...
  try {
    ...
    if (result.count("partition-ico")) {
      ...
      partType = SU2_ICO_ELEMENT;
    } else if (result.count("partition-z2")) {
      partType = Z2_ELEMENT;
    }
    ...
    dimensions = result["dimensions"].as<int>();
  ...
  if (dimensions == 2) {
    executor<2> exec(
      latSize, beta, multiProbe, delta, partType, partFile, subdivs);

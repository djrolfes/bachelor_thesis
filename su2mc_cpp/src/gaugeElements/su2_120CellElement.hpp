...
public:
  ...
  su2_120CellElement(su2Element iIcoPos, int iRotIndex)
    : rotationMatrices C120_ROT_MATRICES
  {
    icoPos = iIcoPos;
    rotIndex = iRotIndex;
  ...
  su2_120CellElement(su2Element iIcoPos, int iRotIndex, double* el)
    : rotationMatrices C120_ROT_MATRICES
  {
    icoPos = iIcoPos;
    rotIndex = iRotIndex;
...
protected:
  su2_120CellElement randomize(int direction)
  {
  ...
  void applyRotation(su2Element& inp, int& rIndex, double* out)
  {
    if (rIndex < 4) {
  ...
  su2Element getIcoMultElement(int index)
  {
